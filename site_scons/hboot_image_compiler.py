...
def main():
	...
	tParser.add_argument('-A', '--alias',       dest='astrAliases',       required=False, nargs='*',         metavar='ALIAS=FILE', help='Add an alias in the form ALIAS=FILE.')
	tParser.add_argument('-I', '--include',     dest='astrIncludePaths',  required=False, nargs='*',         metavar='PATH', help='Add PATH to the list of include paths.')
