...
def Read():
	...
	_g_build_properties.Add(BoolVariable('CFG_BUILD_DEBUG', 'Build the project in debug mode.', 'False'))
...
def PrintSummary():
	...
	print "\tCFG_BUILD_DEBUG = %s" % _g_env_help['CFG_BUILD_DEBUG']


def ApplyToEnv(env):
	global _g_env_help
	
	if _g_env_help['CFG_BUILD_DEBUG']==0:
